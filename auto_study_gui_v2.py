...
class AutoStudyGUI:
    ...
    def init_main_page(self):
        ...
        ttk.Label(exam_settings, text="功能开发中...", font=('Microsoft YaHei UI', 10)).pack(side='left', padx=5)
        ttk.Button(exam_settings, text="开始考试（未开发）", command=self.start_exam,
                  width=20, state='disabled').pack(side='left', padx=10)
    ...
    def start_exam(self):
        """开始考试"""
        messagebox.showinfo("提示", "考试功能尚未开发")
